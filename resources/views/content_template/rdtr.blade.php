        ...
        <div class="table-responsive">
            <table id="pdptable" class="table table-bordered table-striped table-sm" style="color: black; font-weight: normal;">
                ...
                <tbody>
                    ...
                    <td class="text-center"><a target="_blank" href="https://peta-mahulu.herokuapp.com/assets/storage/rdtr/Electrochemical.pdf" style="font-size:11px;color:white;" class="btn btn-primary btn-xs" data-toggle="tooltip" title=Detail><i class="fa fa-download"></i></a></td>
                    </tr>
                </tbody>
            </table>
        </div>
